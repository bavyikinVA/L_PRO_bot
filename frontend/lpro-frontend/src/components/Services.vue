...
<template>
  <div
    ...
    <div class="bg-purple-100 rounded-full p-6 w-28 h-28 flex items-center justify-center mb-4">
    <i :class="icon + ' text-purple-700 text-4xl'" aria-hidden="true"></i>
    </div>
    ...
    <button
        @click="handleBook"
        class="bg-brand hover text-white px-6 py-2 rounded-lg hover:bg-brand-dark transition-colors w-full"
    >
      Записаться
    </button>
  </div>
