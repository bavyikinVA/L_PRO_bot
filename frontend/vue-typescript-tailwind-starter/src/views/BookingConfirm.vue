      ...
      <div class="bg-white rounded-lg shadow-lg w-96 p-6">
        ...
        <div v-else-if="isUserIdReady">
          ...
          <div class="flex justify-around">
            <button
                class="py-2 px-6 bg-green-500 text-white rounded-lg hover:bg-green-600 transition duration-200 disabled:opacity-50"
                @click="createBooking"
                :disabled="isLoading"
            >
    ...
    <div v-if="isSuccessModalOpen" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div class="bg-white rounded-lg shadow-lg w-96 p-6">
        <div class="text-center mb-4">
          ...
          <h2 class="text-2xl font-bold text-green-600 mb-2">Запись успешно создана!</h2>
        </div>
        ...
        <button
            class="w-full py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-200 font-semibold"
